...
(function ($, window, document, undefined) {
    var EZP = {
        ...
        closeAll: function () {
            ...
            if(self.zoomContainer)
            self.zoomContainer.css('visibility', 'hidden');
            self.changeState('disable');
            self.setPosition(self.currentLoc);
        },

        openAll: function () {
            var self = this;
            self.changeState('enable');
            self.changeZoomLevel(0.5);
            if (self.zoomWindow) {
                self.zoomWindow.show();
            }
            if (self.zoomLens) {
            ...
            self.zoomContainer.css('visibility', 'visible');
        },
