    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
          <!-- Horizontal Form -->
          <!-- form start -->
            {!! Form::open(['url' => 'admin/products/edit/'.$product_id, 'class' => 'form-horizontal', 'id' => 'add_product_form', 'files' => true]) !!}   
          <div class="box box-info">
            ...
            <input type="hidden" value="{{ @$result->user_id }}" name="user_id" id="user_id">   
            ...
            <div class="box-header with-border">
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(1)" disabled>Product Information</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(2)">Images and Video</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(3)">Pricing & Details</a>
              
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(5)">Shipping</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(6)">Return & Exchange</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(7)">Organize</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(8)">Status</a>
            ...
            <fieldset class="box-body">
              <div class="form-group">
                  ...
                  <div class="col-sm-6">                    
                    {!! Form::text('title', @$result->title, ['class' => 'form-control', 'id' => 'name', 'placeholder' => 'Product Title']) !!}
                  </div>
                </div>
                <div class="form-group">
                  <label for="calendar" class="col-sm-3 control-label">Description<em class="text-danger">*</em></label>
                  <div class="col-sm-6">   
                  <!-- <textarea id='desc'>{{ @$result->description}}</textarea>      -->
                  <textarea id="description" name="description" class="textInMce " style="width:100% !important;border-top: 0px !important;" >{{ @$result->description}}</textarea>
            ...
            <div class="box-footer">
                 <a href="{{url('admin/products')}}"><button class="btn btn-default" type="button" name="cancel" value="cancel">Cancel</button></a>
                <button class="btn btn-info pull-right" type="submit" name="submit" data-id='1' value="product_information">Submit</button>
              </div>
            </div>
          </div>
            ...
            <div class="box-header with-border">
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(1)" >Product Information</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(2)" disabled>Images and Video</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(3)">Pricing & Details</a>
...
<input type="hidden" id="add_product_video" name="add_product_video">
              <div class="col-sm-6">
               ...
               <!--  <ul id="js-video-grid" class="additional ui-sortable row sortable" ng-show="!video_src">
                    <li class="add col-lg-4 col-md-6 row-space-4" id="add-video"  data-toggle="modal" data-target="#video_upload_popup" >
                        <a href="javascript:void(0)"></a>
                    </li>
                </ul> -->
              ...
              <span class="help-inline text-danger required_img" style="display: none;">
                ...
                <ul id="js-photo-grid" class="additional ui-sortable row  sortable">
                    ...
                    <li ng-repeat="item in photos_list" class="add item col-lg-4 col-md-6 row-space-4" data-id="@{{ $index }}" data-index="0" draggable="true" style="display: list-item;" ng-mouseover="over_first_photo($index)" ng-mouseout="out_first_photo($index)">
                      ...
                      <li class="add new col-lg-4 col-md-6 row-space-4" id="add-image">
                          <a href="javascript::"></a>
                      </li>
                  ...
                  <label id="image_upload_error">{{ trans('messages.products.image_upload_error') }}</label>
            ...
            <div class="box-footer">
                 <a href="{{url('admin/products')}}"><button class="btn btn-default" type="button" name="cancel" value="cancel">Cancel</button></a>
                <button class="btn btn-info pull-right" type="submit" data-id='2' name="submit" value="images">Submit</button>
              </div>
            </div>
            ...
            <div class="box-header with-border">
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(1)">Product Information</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(2)">Images and Video</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(3)" disabled>Pricing & Details</a>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <div class="input-grou">
                  ...
                  <input class="boot_text boot_90" name="price" ng-change="updateDiscount()"  type="text" id="price" ng-model="price" limit-to="9" numbers-only style="width: 94% !important;  float: right;">
                </div>
              </div>
            </div>
            <div class="form-group retail" style="display: none;">
              ...
              <div class="col-sm-6">
                <div class="input-grou">
                  <span class="input-group-addon boot_addon" style="width: 6%">{{ $product_symbol }}</span>
                  <input class="boot_text boot_90" ng-change="updateDiscount()" name="retail_price" type="text" id="retail_price" ng-model="retail_price" limit-to="9" numbers-only style="width: 94% !important; float: right;">
                </div>
              </div>
            </div>
        ...
        <div class="modal-body pay-p">
            <div class="data-frm fixed_summary option">
                ...
                <p class="qty tool_tip_new">
                    ...
                    <span class="sync">
                        <input type="text" ng-model="product_options[$index].option_qty" id="option_quantity_@{{$index}}" class="text"  name="quantity" limit-to="4" value="@{{ item.quantity }}" placeholder="∞" only-number>
            ...
            <div class="back-white col-lg-12 nopad bor-bot-ash">
                <div class="flt-left tool_tip_new" style="width:32.5%;padding: 0 5px 0 0px !important;">
                    ...
                    <div class="input-grou">
                      ...
                      <input class="pop_boot_text ng-pristine ng-untouched ng-valid" name="option_price[]"  type="text"  ng-change="updateOptionDiscount($index)" ng-model="product_options[$index].option_price" limit-to="9" numbers-only>
                    </div>
                ...
                <div class="flt-left  retail retail_@{{ $index }}" style="width: 32.5%; padding: 0 5px 0 0px !important; display: none;">
                    ...
                    <div class="input-grou">
                      <span class="input-group-addon boot_addon">{{ $product_symbol }}</span>
                   <input class="pop_boot_text ng-pristine ng-untouched ng-valid"  ng-change="updateOptionDiscount($index)" name="product_option_retail_price[]" type="text"  id="retail_price" ng-model="product_options[$index].retail_price" limit-to="9" numbers-only>
                ...
                <div class="selectable-option col-xs-12 col-sm-12 col-md-12"><input  type="checkbox" data_id=""  class="check_sale_option check_sale_option_@{{ $index }}" name="product_option_check_sale[@{{ $index }}]"  data="@{{ $index }}" value="@{{ $index }}" > <label for="check-sale">This product is on sale</label>
                </div>
...
<td class="tool_tip_new bt1"><input type="text" name="product_option_qty[]"  id='required_Quantity@{{$index}}'  limit-to="4" class="text qty" placeholder="∞" value="@{{ item.quantity }}" ng-model="product_options[$index].total_quantity" ng-change="product_options[$index].option_qty=product_options[$index].total_quantity" ng-keyup="update_main_quantity()" only-number>
</td>
<td>
<input type="text" name="product_option_sold[]" class="text sold" readonly="readonly" value="@{{ item.sold }}" ng-model="item.sold"></td>
...
<td>
    <a href="#" data-toggle="modal" data-target="#product_option_extra_@{{ $index }}" class="btn-edit editbtn">
        <i class="fa fa-pencil" aria-hidden="true"></i>
              ...
              <div class="box-footer">
                <a href="{{url('admin/products')}}"><button class="btn btn-default" type="button" name="cancel" value="cancel">Cancel</button></a>
                <button class="btn btn-info pull-right" type="submit" name="submit" data-id='3' value="price_details">Submit</button>
              </div>
            </div>
            ...
            <div class="box-header with-border">
              ...
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(2)">Images and Video</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(3)">Pricing & Details</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(4)" disabled>Inventory</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(5)">Shipping</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(6)">Return & Exchange</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(7)">Organize</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(8)">Status</a>
            ...
            <p class="text-danger">(*)Fields are Mandatory</p>  
              ...
              <div class="box-footer">
                 <a href="{{url('admin/products')}}"><button class="btn btn-default" type="button" name="cancel" value="cancel">Cancel</button></a>
                <button class="btn btn-info pull-right" type="submit" name="submit" data-id='4' value="inventory">Submit</button>
              </div>
            </div>
 
            <div id="sf5" class="frm add-shipping" style="display: none;">
            <div class="box-header with-border">
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(1)">Product Information</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(2)">Images and Video</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(3)">Pricing & Details</a>
              
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(5)" disabled>Shipping</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(6)">Return & Exchange</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(7)">Organize</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(8)">Status</a>
            </div>
...
<tbody>
    <tr ng-repeat="item in shipping" ng-init="item.index = $index">
        ...
        <td><div class="tool_tip_new"><input maxlength="3" valid-number limit-to="8" class="text expected_delivery_day_1" name="expected_delivery_day_1[]" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" value="" type="text" id="start_window_@{{ $index }}" ng-model="item.start_window"> - <input maxlength="3" valid-number limit-to="8" class="text start-day expected_delivery_day_2" name="expected_delivery_day_2[]" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" value="" type="text"  id="end_window_@{{ $index }}" ng-model="item.end_window"></div></td>
              ...
              <div class="box-footer">
                <a href="{{url('admin/products')}}"><button class="btn btn-default" type="button" name="cancel" value="cancel">Cancel</button></a>
                <button class="btn btn-info pull-right" type="submit" name="submit" data-id='5' value="shipping">Submit</button>
              </div>
            </div>
            ...
            <div class="box-header with-border">
              ...
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(5)">Shipping</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(6)" disabled>Return & Exchange</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(7)">Organize</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(8)">Status</a>
            </div>
            <p class="text-danger">(*)Fields are Mandatory</p>  
            <fieldset class="box-body policy">
                ...
                <div class="form-group">
                  <div class="col-sm-3 control-label"></div>
                  <div class="selectable-option col-sm-6" style="margin-left: 15px !important;">
                ...
                <div class="form-group use_exchange" style="display: none; width: unset !important;">
                  ...
                  <div class="col-sm-6">                     
                     <select class="exchange-policy" name="exchange_policy" ng-model="exchange_policy" ng-init="exchange_policy={{@$return_policy_value}}" style="width:102%">
                                @foreach($return_policy as $rpolicy)
                                  <option value="{{ $rpolicy->id }}" >{{ $rpolicy->name }}</option>
                                @endforeach
                            </select>
              ...
              <div class="box-footer">
                <a href="{{url('admin/products')}}"><button class="btn btn-default" type="button" name="cancel" value="cancel">Cancel</button></a>
                <button class="btn btn-info pull-right" type="submit" name="submit" data-id='6' value="return_exchange">Submit</button>
              </div>
            </div>
            ...
            <div class="box-header with-border">
              ...
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(5)">Shipping</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(6)">Return & Exchange</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(7)" disabled>Organize</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(8)">Status</a>
            </div>
            <p class="text-danger">(*)Fields are Mandatory</p>  
            <fieldset class="box-body">
              ...
              <div class="box-footer">
                 <a href="{{url('admin/products')}}"><button class="btn btn-default" type="button" name="cancel" value="cancel">Cancel</button></a>
                <button class="btn btn-info pull-right" type="submit" name="submit" data-id='7' value="organize">Submit</button>
              </div>
            </div>
            ...
            <div class="box-header with-border">
              ...
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(6)">Return & Exchange</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(7)">Organize</a>
              <a href="javascript:void(0);" class="btn btn-warning" onclick="step(8)" disabled>Status</a>
            </div> 
            <p class="text-danger">(*)Fields are Mandatory</p>
           <fieldset class="box-body">
                <div class="form-group">
              ...
              <div class="box-footer">
                 <a href="{{url('admin/products')}}"><button class="btn btn-default" type="button" name="cancel" value="cancel">Cancel</button></a>
                <button class="btn btn-info pull-right" type="submit" name="submit" data-id='8' value="status">Submit</button>
              </div>
            </div>
