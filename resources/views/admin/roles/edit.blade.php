          ...
          <div class="box box-info">
            ...
            <!-- form start -->
              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Permissions <em class="text-danger">*</em></label>
...
$('.permission_check').click(function(){
  ...
  if ($('input[value="'+permission_id +'"]').is(":checked"))
  {
    if(permission_id == '3' || permission_id =='4' || permission_id == '5'){
      $("input[value='2']").prop('checked', true).attr("disabled","disabled");
    }
    else if(permission_id == '8' || permission_id == '9' || permission_id=='10'){
      $("input[value='7']").prop('checked', true).attr("disabled","disabled");;
    }
  }
  else{
      if(!$('input[value="3"]').is(":checked")  && !$('input[value="4"]').is(":checked") && !$('input[value="5"]').is(":checked")){
        $("input[value='2']").prop('checked', false).removeAttr("disabled");
      }
      else if(!$('input[value="8"]').is(":checked") && !$('input[value="9"]').is(":checked") && !$('input[value="10"]').is(":checked")){
        $("input[value='7']").prop('checked', false).removeAttr("disabled");
      }
  }
