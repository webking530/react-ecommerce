      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => 'admin/edit_return_policy/'.$result->id, 'class' => 'form-horizontal']) !!}
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('days', $result->days, ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => 'Days']) !!}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('name',$result->name, ['class' => 'form-control', 'placeholder' => 'Display Text']) !!}
