...
class EmailSettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('email_settings')->insert([
        		...
        		['name' => 'port', 'value' => '25'],
        		['name' => 'from_address', 'value' => 'spiffytrioangle@gmail.com'],
        		['name' => 'from_name', 'value' => 'Spiffy'],
        		['name' => 'encryption', 'value' => 'tls'],
        		['name' => 'username', 'value' => 'spiffytrioangle@gmail.com'],
        		['name' => 'password', 'value' => 'exejetqxduzzbacz'],
